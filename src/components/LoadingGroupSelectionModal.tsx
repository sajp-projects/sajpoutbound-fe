        ...
        <div className="flex flex-col max-h-[75vh]">
          <DialogHeader className="p-6 pb-4 border-b border-gray-100 flex-shrink-0">
            ...
            <DialogDescription className="text-sm sm:text-base text-gray-600">
              Pilih grup pemuatan yang akan ditimbang. Grup dibentuk berdasarkan DO yang dimuat bersamaan.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-0">
            ...
            <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
              <p className="text-xs sm:text-sm text-purple-900">
                <span className="font-medium">Catatan:</span> Anda hanya dapat menimbang DO yang dimuat bersamaan sebagai satu grup.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {!loadingGroups || loadingGroups.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  <p className="text-sm">Tidak ada grup pemuatan yang tersedia</p>
                </div>
              ) : (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 pl-3 border-l-2 border-gray-200">
                        {group.doNumbers?.map((doNumber, doIndex) => (
                          <div key={doIndex} className="flex items-center gap-2">
                            <Package className="w-3.5 h-3.5 text-gray-400 flex-shrink-0" />
                            <span className="text-sm text-gray-700 font-medium">{doNumber}</span>
                          </div>
                        ))}
                      </div>
