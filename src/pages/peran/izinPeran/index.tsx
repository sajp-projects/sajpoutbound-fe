...
import {
  InfoBanner,
  PageHeader,
} from "@/pages/izin/daftarIzin/_components";
...
export default function IzinPeran() {
  ...
  const handlePermissionToggle = (permissionId: string) => {
    setSelectedPermissions(prev => {
      ...
      const hasChanges = newSet.size !== originalIds.size || 
  ...
  const handleSave = () => {
    ...
    if (changedPermissions.length > 0) {
      ...
      showSuccessAlert("Tidak Ada Perubahan", "Tidak ada perubahan yang perlu disimpan");
      setHasChanges(false);
    }
  };
          ...
          <div className="flex items-center gap-3">
            ...
            {hasChanges && (
              ...
              >
                ...
                {updateRolePermissionsMutation.isPending ? "Menyimpan..." : "Simpan"}
              </Button>
            )}
          </div>
        </div>
