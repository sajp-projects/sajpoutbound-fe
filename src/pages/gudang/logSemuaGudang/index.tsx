...
export default function LogSemuaGudang() {
  ...
  const renderChanges = (
    ...
    if (newData && !oldData) {
      return (
        <div>
          <div className="text-xs font-medium text-gray-600 mb-1">Data gudang yang dibuat:</div>
          <div className="overflow-x-auto w-full">
            <table className="w-full text-xs border-collapse">
              <tbody>
                ...
                <tr>
                  <td className="font-medium bg-gray-50 w-[120px] border border-gray-200 p-1">Deskripsi</td>
    ...
    if (oldData && !newData) {
      return (
        <div>
          <div className="text-xs font-medium text-gray-600 mb-1">Data gudang yang dihapus:</div>
          <div className="overflow-x-auto w-full">
            <table className="w-full text-xs border-collapse">
              <tbody>
                <tr>
