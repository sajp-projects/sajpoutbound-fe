        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex flex-wrap gap-2 w-full sm:w-auto">
            ...
            <Button
              ...
              size="sm"
              className="bg-white text-gray-700 border-gray-300 hover:bg-gray-50 text-xs sm:text-sm"
              onClick={() => (refetch as () => Promise<unknown>)()}
            >
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50 border-b border-gray-200">
                      ...
                      <TableHead
                        className="font-semibold text-gray-700 py-4 cursor-pointer hover:bg-gray-100"
                      ...
                      <TableHead
                        className="hidden md:table-cell font-semibold text-gray-700 py-4 cursor-pointer hover:bg-gray-100"
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border-t border-gray-200 mt-4 gap-4">
              ...
              <div className="flex items-center justify-center gap-1 sm:gap-2 flex-wrap">
                <Button
                  ...
                  className="border-gray-300 text-gray-700 hover:bg-gray-50 h-8 px-2 sm:px-3"
                >
