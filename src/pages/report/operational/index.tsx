...
import DataOperasionalTable from "@/components/report/DataOperationalTable";
...
import { useOperationalReport } from "@/hooks/report";
...
export default function LaporanOperasional() {
  ...
  const [shipmentType, setShipmentType] = useState<"ALL" | "ANTAR" | "JEMPUT">(
    () => {
      ...
      return typeParam === "ANTAR" || typeParam === "JEMPUT"
        ? typeParam
        : "ALL";
    }
  );
