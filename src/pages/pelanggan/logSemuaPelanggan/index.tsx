...
export default function LogSemuaPelanggan() {
  ...
  const renderChanges = (
    ...
    if (newData && !oldData) {
      return (
        <div>
          <div className="text-xs font-medium text-gray-600 mb-1">Data pelanggan yang dibuat:</div>
          <div className="overflow-x-auto w-full">
            <table className="w-full text-xs border-collapse">
              <tbody>
                ...
                <tr>
                  <td className="font-medium bg-gray-50 w-[120px] border border-gray-200 p-1">ID</td>
    ...
    if (oldData && !newData) {
      return (
        <div>
          <div className="text-xs font-medium text-gray-600 mb-1">Data pelanggan yang dihapus:</div>
          <div className="overflow-x-auto w-full">
            <table className="w-full text-xs border-collapse">
              <tbody>
                <tr>
                  <td className="font-medium bg-gray-50 w-[120px] border border-gray-200 p-1">Nama</td>
                  <td className="whitespace-nowrap overflow-hidden text-ellipsis max-w-full border border-gray-200 p-1">{oldData.name as string}</td>
                </tr>
                <tr>
                  <td className="font-medium bg-gray-50 w-[120px] border border-gray-200 p-1">ID</td>
                  <td className="whitespace-nowrap overflow-hidden text-ellipsis max-w-full border border-gray-200 p-1">
                ...
                >
                  ...
                  <TableCell>
                    {log.customer ? (
                      ...
                      <div className="font-medium text-gray-700 whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px]">
                        {getCustomerName(log)}
                      </div>
                    )}
                  </TableCell>
